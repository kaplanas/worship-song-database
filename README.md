...
Warning: this is <i>not</i> just a single flat table!  Check out the [ERD](database_files/wsdb_erd.png) for a guide to how things are structured.  It's not quite 3NF, but it's close.
