...
manage.artists.info = list(
  ...
  columns = data.frame(
    ...
    width = c(150, 100, 100, 100, 80, 200, 200),
...
manage.copyright.administrators.info = list(
  ...
  columns = data.frame(
    ...
    width = c(200, 200, 100, 100, 100, 50, 70, 200, 200, 200, 200),
...
manage.meters.info = list(
  ...
  columns = data.frame(
    ...
    width = c(100, 200, 100, 200, 200, 200),
...
manage.key.signatures.info = list(
  ...
  columns = data.frame(
    ...
    width = c(150, 150, 150, 150, 200, 200),
...
manage.songbooks.info = list(
  ...
  columns = data.frame(
    ...
    key.table = rep(NA_character_, 6),
    key.label = rep(NA_character_, 6),
    width = c(100, 500, 100, 100, 200, 200),
    type = c("numeric", "text", "text", "text", "date", "date"),
    editable = c(F, T, T, T, F, F),
    html = rep(F, 6),
    stringsAsFactors = F
